...
USE db_SalesClothes
GO
--4.Configurar el idioma espa�ol el motor de base de datos.
...
---5.Configurar el formato de fecha en dmy (d�a, mes y a�o) en el motor de base de datos.
...
GO
     ...
     --6.5 Agregar restricci�n primary key 
ALTER TABLE client
	ADD CONSTRAINT client_pk 
	PRIMARY KEY (id)
GO

     --6.6 El tipo de documento puede ser DNI � CNE 
ALTER TABLE client
	DROP COLUMN type_document
GO

     --6.7 Agregar restricci�n para tipo documento 
ALTER TABLE client
...
GO
     ...
     --6.9 El n�mero de documento s�lo debe permitir d�gitos de 0 - 9 
ALTER TABLE client
...
GO
     ...
     --6.13 Validar que el celular est� conformado por 9 n�meros 
ALTER TABLE client
...
GO
     ...
     --6.15 S�lo debe permitir el registro de clientes mayores de edad
ALTER TABLE client
	ADD  birthdate date
...
GO
     ...
     --6.17 El valor predeterminado ser� activo al registrar clientes 
ALTER TABLE client
...
GO
     ...
     --7.5 El tipo de documento puede ser DNI � CNE 
ALTER TABLE seller
	DROP COLUMN type_document
GO

     --7.6 Agregar restricci�n para tipo documento 
ALTER TABLE seller
	ADD type_document char(3)
...
GO
     ...
     --7.8 El n�mero de documento s�lo debe permitir d�gitos de 0 - 9 
ALTER TABLE seller
	ADD number_document char(9)
...
GO
     ...
     --7.13 Validar que el celular est� conformado por 9 n�meros 
ALTER TABLE seller
	ADD cell_phone char(9)
...
GO
     ...
     --7.17 El valor predeterminado ser� activo al registrar sellers
ALTER TABLE seller
	ADD active bit DEFAULT (1)
GO
...
GO
     ...
     --8.5 Agregar restricci�n primary key
ALTER TABLE clothes
...
GO
     ...
     --8.7 El valor predeterminado ser� activo al registrar clothes
ALTER TABLE clothes
	ADD active bit DEFAULT (1)
GO
...
--10 Listar todos los datos de los clientes (client) cuyo servidor de correo electr�nico sea outlook.com.
SELECT *
FROM client
...
--14 Eliminar l�gicamente los datos de un cliente client de acuerdo a un determinado id.
UPDATE client
SET active = '0' 
WHERE id = '2'
GO

--15 Eliminar l�gicamente los datos de un cliente seller de acuerdo a un determinado id.
UPDATE seller
SET active = '0' 
WHERE id = '1'
GO

--16 Eliminar l�gicamente los datos de un cliente clothes de acuerdo a un determinado id 
UPDATE clothes
SET active = '0' 
WHERE id = '4'
GO